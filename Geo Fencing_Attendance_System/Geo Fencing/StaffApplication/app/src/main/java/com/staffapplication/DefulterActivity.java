...
public class DefulterActivity extends AppCompatActivity {
   ...
   // EditText studentname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defulter);
            ...
            public void onClick(View v) {
               ...
               // StudentName = studentname.getText().toString().trim();
                if (StartDate.length() == 0) {
                    Toast.makeText(DefulterActivity.this, "Enter Start Date", Toast.LENGTH_SHORT).show();
                    datestart.requestFocus();
                } else if (EndDate.length() <= 0) {
                    Toast.makeText(DefulterActivity.this, "Enter End Date", Toast.LENGTH_SHORT).show();
                    ...
                    if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                        ...
                        Intent i = new Intent(DefulterActivity.this, DefulterListActivity.class);
                        i.putExtra("sdate", StartDate);
                        i.putExtra("edate", EndDate);
                        i.putExtra("subject", Subject);
                        Log.d("sameen",""+StartDate);
                        Log.d("sameen",""+EndDate);
                        Log.d("sameen",""+Subject);
                        startActivity(i);
                        // new GetPercen().execute();

                    }
                    else{
                        Toast.makeText(DefulterActivity.this,"Please Connect To Working Internet", Toast.LENGTH_SHORT).show();
                    }
    ...
    class ListCall extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DefulterActivity.this);
        ...
        protected void onPostExecute(String file_url){
            if(lsubject.length>0) {
                final ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(DefulterActivity.this, android.R.layout.simple_spinner_item, lsubject);
    ...
    class GetPercen extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String...args){
            ...
            Log.d("sameen",""+params);
            //String url_list_details =  "http://www.proitce.com/umesh/wifiattend/Staffapp/getAttendance.php";
          ...
          //  json = jParser.makeHttpRequest(url_list_details, "POST", params);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Handler handler = new Handler(DefulterActivity.this.getMainLooper());
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            Toast.makeText(DefulterActivity.this, message, Toast.LENGTH_LONG).show();
                        }
                    });
